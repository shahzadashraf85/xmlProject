...
echo $csp = Get-CimInstance Win32_ComputerSystemProduct >> "%SPECS_SCRIPT%"
...
echo if ($cs.Manufacturer -match "Lenovo") { "MODEL=" + $csp.Version } else { "MODEL=" + $cs.Model } >> "%SPECS_SCRIPT%"
